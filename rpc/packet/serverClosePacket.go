...
type ServerClosePacket struct {
	Type    int16
	Length  int
	Payload []byte
}

func NewServerClosePacket() *ServerClosePacket {
	return &ServerClosePacket{
		Type: ControlServerClose,
	}
}

// Decode ...
func (c *ServerClosePacket) Decode(conn net.Conn, reader io.Reader) error {
	buf := make([]byte, 4)
...
// Encode ...
func (c *ServerClosePacket) Encode() ([]byte, error) {
	body := make([]byte, 6)
...
// GetPacketType ...
func (c *ServerClosePacket) GetPacketType() int16 {
	return c.Type
}

// GetPayload ...
func (c *ServerClosePacket) GetPayload() []byte {
	return c.Payload
}

// GetRequestID ...
func (c *ServerClosePacket) GetRequestID() int {
	return 0
}
