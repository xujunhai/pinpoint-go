...
func NewStreamResponsePacket() *StreamResponsePacket {
...
// Decode ...
func (a *StreamResponsePacket) Decode(conn net.Conn, reader io.Reader) error {
	buf := make([]byte, 8)
...
// Encode ...
func (a *StreamResponsePacket) Encode() ([]byte, error) {
	body := make([]byte, 10)
...
// GetPacketType ...
func (a *StreamResponsePacket) GetPacketType() int16 {
	return a.Type
}

// GetPayload ...
func (a *StreamResponsePacket) GetPayload() []byte {
	return a.Payload
}

// GetRequestID ...
func (a *StreamResponsePacket) GetRequestID() int {
	return 0
}
